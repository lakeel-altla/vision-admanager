...
import com.lakeel.altla.vision.admanager.presentation.presenter.UserImageAssetEditPresenter;
...
public final class UserImageAssetEditFragment
        extends AbstractFragment<UserImageAssetEditView, UserImageAssetEditPresenter>
        implements UserImageAssetEditView {

    private static final int REQUEST_CODE_ACTION_OPEN_DOCUMENT = 0;

    @Inject
    UserImageAssetEditPresenter presenter;
    ...
    @NonNull
    public static UserImageAssetEditFragment newInstance(@Nullable String imageId) {
        UserImageAssetEditFragment fragment = new UserImageAssetEditFragment();
        Bundle bundle = UserImageAssetEditPresenter.createArguments(imageId);
        fragment.setArguments(bundle);
        return fragment;
    }

    @Override
    protected UserImageAssetEditPresenter getPresenter() {
        return presenter;
    }

    @Override
    protected UserImageAssetEditView getViewInterface() {
        return this;
    }
    ...
    protected View onCreateViewCore(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_user_image_asset_edit, container, false);
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.fragment_user_image_asset_edit, menu);
    }
